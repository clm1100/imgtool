...
async function deal100x30({ productname = "彼岸准时钟", producttype = "HYCX-YU-110", productdate ="2020-12-12",productpeople="001"}={},res) {
    ...
    if (getLength(productname)<=16){
        let { nameLeft, nameTop, typeLeft, typeTop, peopleLeft, peopleTop, dateLeft, dateTop, waterLeft, waterTop,waterLeft2,waterTop2 } = {
            nameLeft: Left,
            nameTop: 410+Top,
            typeLeft: Left,
            typeTop: 490+Top,
        ...
        for (let j = 0; j < 4; j++) {
            for (let i = 0; i < 4; i++) {
                ...
                out.draw(images("./jnmz.png"), waterLeft2 + offsetLeft * i, waterTop2 + j * offsetTop)
            }
        ...
        let { nameLeft, nameTop,nameLeft1,nameTop1, typeLeft, typeTop, peopleLeft, peopleTop, dateLeft, dateTop, waterLeft, waterTop,waterLeft2,waterTop2 } = {
            nameLeft: Left,
            nameTop: 370+Top,
            nameLeft1: Left,
            nameTop1: 410+Top,
